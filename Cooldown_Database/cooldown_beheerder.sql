...
LOCK TABLES `beheerder` WRITE;
/*!40000 ALTER TABLE `beheerder` DISABLE KEYS */;
INSERT INTO `beheerder` VALUES (1,'djelies','qwerty','djelies.msk@hotmail.nl');
/*!40000 ALTER TABLE `beheerder` ENABLE KEYS */;
UNLOCK TABLES;
